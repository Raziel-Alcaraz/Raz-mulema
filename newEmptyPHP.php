<?php
/**
 * Plugin Name: Envia.com Module - Hacked by Raziel
 ...
 * Author: Tendecys Innovations - Hacked by Raziel
 * Author URI: https://www.envia.com/
 * Text Domain: Envia.com Module - Hacked by Raziel
 */
...
wp_enqueue_script( 'envia_yeykueri_script', plugins_url( 'assets/js/yeykueri.js', __FILE__ ), array(), '4' );
if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
	...
	function wp_enqueue_custom_scriptsheets() {
		wp_enqueue_script( 'envia_yeykueri_script', plugins_url( 'assets/js/yeykueri.js', __FILE__ ), array(), '4' );
		wp_enqueue_script( 'envia_bootstrap_script', plugins_url( 'assets/js/bootstrap.min.js', __FILE__ ), array(), '5' );
					...
					if ( 'yes' == $this->active ) {
						...
						if ( is_array( $response ) ) {
							foreach ( $response as $key => $value ) {
								$rate = array(
									'id'      => $key + 1,
									'label' => $value->carrier . '(' . $value->serviceDescription . ')',
